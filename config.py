...
class DevelopmentConfig(Config):
    ...
    S3_PROFILE_IMAGE_BUCKET_NAME = 'dev-fashion-assistant-user-profile-image-bucket'
...
class ProductionConfig(Config):
    ...
    S3_PROFILE_IMAGE_BUCKET_NAME = 'prod-fashion-assistant-user-profile-image-bucket'
